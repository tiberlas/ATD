...
public class ServerDiscovery {
	...
	public List<Host> findAllActiveNodes() {
		
		Set<String> vnetIP = new HashSet<String>();;
			...
			while (addresses.hasMoreElements()){
			    ...
			    if (ip instanceof Inet4Address){
			        if (ip.isSiteLocalAddress()){
			            ...
			            if(ip.getHostName().contains("vboxnet")) {
			            	vnetIP.add(ip.getHostAddress());
			            }
        ...
        vnetIP.forEach(vnet -> {
        	...
        	for(int i=0; i<255; ++i) {
        		...
        		try {
                	String adr = "http://"+potentialHostAddress+i+":8080/ATD_WAR/ATD/identify";
